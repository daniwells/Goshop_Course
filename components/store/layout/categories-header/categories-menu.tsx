    ...
    >
        <div className="relative">
            <div className={cn("w-12 xl:w-[256px] h-12 rounded-full -translate-y-1 xl:translate-y-0 xl:h-11 bg-[#535353] text-white text-[20px] relative flex items-center cursor-pointer transition-all duration-100 ease-in-out", 
                {
                    "w-[256px] bg-[#f5f5f5] text-black text-base rounded-t-[20px] rounded-b-none scale-100":open,
                    "scale-75":!open,
                }
            )}>
                <Menu className={cn("absolute top-1/2 -translate-y-1/2 xl:ml-1",{
                    "left-5":open,
                    "left-3":!open
                })}/>
                <span className={cn("hidden xl:inline-flex xl:ml-11", {
            ...
            <div className={cn("absolute top-10 left-0 w-[256px] bg-[#f5f5f5] shadow-lg transition-all duration-100 ease-in-out overflow-y-auto scrollbar", {
                    ...
                    categories.map((category) => (
                        ...
                        >
                            <li className="relative flex items-center m-0 p-3 pl-6 hover:bg-white">
                                ...
                                />
                                <span className="text-sm font-normal ml-2 overflow-hidden line-clamp-2 wrap-break-words text-main-primary">
                                    {category.name}
                                </span>
                            </li>
                        </Link>
