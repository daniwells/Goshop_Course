...
export default function DownloadApp() {
    return <div className="relative group">
        ...
        <div className="absolute hidden top-0 group-hover:block cursor-pointer">
            <div className="relative mt-12 -ml-44 w-[300px] bg-white rounded-3xl text-main-primary pt-2 px-1 pb-6 z-50 shadow-lg">
                <div className="w-0 h-0 absolute -top-1.5 left-36 border-l-[10px] border-l-transparent border-b-[10px] border-white border-r-[10px] border-r-transparent"/>
