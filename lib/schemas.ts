...
import { ShippingFeeMethod } from "./generated/prisma/enums";

export const CategoryFormSchema = z.object({
    name: z
        .string({
            required_error: "Category name is required.",
            invalid_type_error: "Category nale must be string.",
        })
        .min(2, {message:"Category name must be at least 2 characters long."})
        .max(50, {message:"Category name cannot exceed 50 characteres."})
        .regex(/^[a-zA-Z0-9\s]+$/, {
    ...
    url: z
        ...
        .regex(/^(?!.*(?:[-_ ]){2,})[a-zA-Z0-9_-]+$/, {
            message: "Only letters, numbers, hyphen, and underscore are allowed in the category url and consecutive occurrences of hyphens, underscores, or spaces are not permitted."
        }),
...
export const SubCategoryFormSchema = z.object({
    name: z
        .string({
            ...
            invalid_type_error: "SubCategory nale must be string.",
        })
        .min(2, {message:"SubCategory name must be at least 2 characters long."})
        .max(50, {message:"SubCategory name cannot exceed 50 characteres."})
        .regex(/^[a-zA-Z0-9\s]+$/, {
    ...
    url: z
        ...
        .min(2, { message: "SubCategory must be at least 2 characters long." })
        .max(50, { message: "SubCategory url cannot exceed 50 characters." })
        .regex(/^(?!.*(?:[-_ ]){2,})[a-zA-Z0-9_-]+$/, {
            message: "Only letters, numbers, hyphen, and underscore are allowed in the subCategory url and consecutive occurrences of hyphens, underscores, or spaces are not permitted."
        }),
    featured: z.boolean().default(false),
...
export const StoreFormSchema = z.object({
    name: z
        .string({
            ...
            invalid_type_error: "Store nale must be string.",
        })
        .min(2, {message:"Store name must be at least 2 characters long."})
        .max(50, {message:"Store name cannot exceed 50 characteres."})
        .regex(/^[a-zA-Z0-9\s]+$/, {
            message: "Only letters, numbers, and spaces are allowed in the store name."
        }),
    description: z
        .string({
        ...
        .min(30, { message: "Store description must be at least 30 characters long." })
        .max(500, { message: "Store description cannot exceed 500 characters." }),    
    email: z
        .string({
            required_error: "Store email is required.",
            invalid_type_error: "Store email must be string.",
        })
...
export const OfferTagFormSchema = z.object({
  ...
  url: z
    ...
    .regex(/^(?!.*(?:[-_ ]){2,})[a-zA-Z0-9_-]+$/, {
      message:
        "Only letters, numbers, hyphen, and underscore are allowed in the offer tag url, and consecutive occurrences of hyphens, underscores, or spaces are not permitted.",
    }),
});
